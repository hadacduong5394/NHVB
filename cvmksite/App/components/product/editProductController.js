(function (app) {
    ...
    editProductController.$inject = ['$scope', 'apiService', 'notificationService', '$state', '$ngBootbox', '$stateParams'];
    function editProductController($scope, apiService, notificationService, $state, $ngBootbox, $stateParams) {
        $scope.types = [];
        $scope.groups = [];
        ...
        $scope.getbykey = function () {
            ...
            apiService.get('api/product/getbykey', config, function (result) {
                ...
                $scope.Images = JSON.parse($scope.product.Images);
                $scope.props = JSON.parse($scope.product.JsonProps);
